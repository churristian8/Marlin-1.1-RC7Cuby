...
#define MSG_LEVEL_BED_CANCEL                "\xc4\xd8\xd4\xd2"                                                 // "ï¾„ï¾˜ï¾”ï¾’" ("Cancel")
...
#define MSG_SELECT                          "\xbe\xdd\xc0\xb8"                                                 // "ï½¾ï¾�ï¾€ï½¸" ("Select")
  ...
  #define MSG_VXY_JERK                      "XY\xbc\xde\xb8\x20\xd4\xb8\xc4\xde mm/s"                          // "XYï½¼ï¾žï½¸ ï¾”ï½¸ï¾„ï¾ž mm/s" ("Vxy-jerk")
  #define MSG_VZ_JERK                       "Z\xbc\xde\xb8\x20\xd4\xb8\xc4\xde mm/s"                           // "Zï½¼ï¾žï½¸ ï¾”ï½¸ï¾„ï¾ž mm/s" ("Vz-jerk")
  ...
  #define MSG_VXY_JERK                      "XY\xbc\xde\xb8\x20\xd4\xb8\xc4\xde"                               // "XYï½¼ï¾žï½¸ ï¾”ï½¸ï¾„ï¾ž" ("Vxy-jerk")
  #define MSG_VZ_JERK                       "Z\xbc\xde\xb8\x20\xd4\xb8\xc4\xde"                                // "Zï½¼ï¾žï½¸ ï¾”ï½¸ï¾„ï¾ž" ("Vz-jerk")
...
#define MSG_VOLUMETRIC                      "\xcc\xa8\xd7\xd2\xdd\xc4"                                         // "ï¾Œï½¨ï¾—ï¾’ï¾�ï¾„" ("Filament")
...
#define MSG_STORE_EPROM                     "\xd2\xd3\xd8\xcd\xb6\xb8\xc9\xb3"                                 // "ï¾’ï¾“ï¾˜ï¾�ï½¶ï½¸ï¾‰ï½³" ("Store memory")
#define MSG_LOAD_EPROM                      "\xd2\xd3\xd8\xb6\xd7\xd6\xd0\xba\xd0"                             // "ï¾’ï¾“ï¾˜ï½¶ï¾—ï¾–ï¾�ï½ºï¾�" ("Load memory")
...
#define MSG_RESUMING                        "\xcc\xdf\xd8\xdd\xc4\xbb\xb2\xb6\xb2"                             // "ï¾Œï¾Ÿï¾˜ï¾�ï¾„ï½»ï½²ï½¶ï½²" ("Resuming print")
...
#define MSG_HEATING_COMPLETE                "\xb6\xc8\xc2\xb6\xdd\xd8\xae\xb3"                                 // "ï½¶ï¾ˆï¾‚ï½¶ï¾�ï¾˜ï½®ï½³" ("Heating done.")
#define MSG_BED_HEATING                     "\xcd\xde\xaf\xc4\xde\x20\xb6\xc8\xc2\xc1\xad\xb3"                 // "ï¾�ï¾žï½¯ï¾„ï¾ž ï½¶ï¾ˆï¾‚ï¾�ï½­ï½³" ("Bed Heating.")
#define MSG_BED_DONE                        "\xcd\xde\xaf\xc4\xde\x20\xb6\xc8\xc2\xb6\xdd\xd8\xae\xb3"         // "ï¾�ï¾žï½¯ï¾„ï¾ž ï½¶ï¾ˆï¾‚ï½¶ï¾�ï¾˜ï½®ï½³" ("Bed done.")
...
#endif
#define MSG_FILAMENT_CHANGE_HEADER          "\xcc\xa8\xd7\xd2\xdd\xc4\xba\xb3\xb6\xdd"                         // "ï¾Œï½¨ï¾—ï¾’ï¾�ï¾„ï½ºï½³ï½¶ï¾�" ("CHANGE FILAMENT")
#define MSG_FILAMENT_CHANGE_OPTION_HEADER   "\xc4\xde\xb3\xbb\xa6\xbe\xdd\xc0\xb8\xbc\xc3\xb8\xc0\xde\xbb\xb2" // "ï¾„ï¾žï½³ï½»ï½¦ï½¾ï¾�ï¾€ï½¸ï½¼ï¾ƒï½¸ï¾€ï¾žï½»ï½²" ("CHANGE OPTIONS:")
#define MSG_FILAMENT_CHANGE_OPTION_EXTRUDE  "\xbb\xd7\xc6\xb5\xbc\xc0\xde\xbd"                                 // "ï½»ï¾—ï¾†ï½µï½¼ï¾€ï¾žï½½" ("Extrude more")
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   "\xcc\xdf\xd8\xdd\xc4\xbb\xb2\xb6\xb2"                             // "ï¾Œï¾Ÿï¾˜ï¾�ï¾„ï½»ï½²ï½¶ï½²" ("Resume print")
  ...
  #define MSG_FILAMENT_CHANGE_EXTRUDE_1     "\xcc\xa8\xd7\xd2\xdd\xc4\xb5\xbc\xc0\xde\xbc\xc1\xad\xb3"         // "ï¾Œï½¨ï¾—ï¾’ï¾�ï¾„ï½µï½¼ï¾€ï¾žï½¼ï¾�ï½­ï½³" ("Wait for")
  #define MSG_FILAMENT_CHANGE_EXTRUDE_2     "\xbc\xca\xde\xd7\xb8\xb5\xcf\xc1\xb8\xc0\xde\xbb\xb2"             // "ï½¼ï¾Šï¾žï¾—ï½¸ï½µï¾�ï¾�ï½¸ï¾€ï¾žï½»ï½²" ("filament extrude")
  ...
  #define MSG_FILAMENT_CHANGE_EXTRUDE_1     "\xcc\xa8\xd7\xd2\xdd\xc4\xb5\xbc\xc0\xde\xbc\xc1\xad\xb3"         // "ï¾Œï½¨ï¾—ï¾’ï¾�ï¾„ï½µï½¼ï¾€ï¾žï½¼ï¾�ï½­ï½³" ("Extruding...")
