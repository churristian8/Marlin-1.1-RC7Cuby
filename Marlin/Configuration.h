...
#define CUSTOM_MACHINE_NAME "Cuby RC7"
...
//#define USE_YMIN_PLUG // <-- comentar este
#define USE_ZMIN_PLUG
//#define USE_XMAX_PLUG
#define USE_YMAX_PLUG // <-- descomentar este
...
//#define Z_SERVO_ANGLES {180,0} // Z Servo Deploy and Stow angles
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER 1.30   // Z offset: -below +above  [the nozzle]
...
// :[-1,1]
#define X_HOME_DIR -1
#define Y_HOME_DIR 1 // <-- Este le he puesto yo así
#define Z_HOME_DIR -1
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,160,6400,185}  // default steps per unit for Ultimaker
...
//Deprecated //#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 180,0} // X,Y,Z Axis Extend and Retract angles
