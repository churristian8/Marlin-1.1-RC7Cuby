...
#ifndef MOTHERBOARD
  #define MOTHERBOARD 46
#endif

// Optional custom name for your RepStrap or other custom machine
// Displayed in the LCD "Ready" message
#define CUSTOM_MACHINE_NAME "Cuby 1.1.6"
#define CUSTOM_MACHINE_NAME "Cuby 1.1.8asdfadf"
...
//
#define LCD_FEEDBACK_FREQUENCY_DURATION_MS 00
...
#define DEFAULT_NOMINAL_FILAMENT_DIA 3.0   // (mm) Diameter of the filament generally used (3.0 or 1.75mm), also used in the slicer. Used to validate sensor reading.
